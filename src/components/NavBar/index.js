...
class NavBar extends React.Component {
  ...
  fetchusers = async () => {
    ...
    const url = process.env.REACT_APP_BE_URL + "/profile"

    try {
      let response = await fetch(url)

      let users = await response.json()
      console.log("navusers", users.data)

      if (response.ok) {
        this.setState({ rawUsers: users.data, loading: false })
      } else {
  ...
  fetchProfile = async () => {
    ...
    const url = process.env.REACT_APP_BE_URL + userId
              ...
              <Link to="/profile/me" className="nav-link">
                ...
                <Dropdown>
                  ...
                  <Dropdown.Menu id="meMenu" style={{ minWidth: "300px" }}>
                    ...
                    <Dropdown.Divider />
                    <Dropdown.Item onClick={this.handleLogout} eventKey="11">
                      Sign Out
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
