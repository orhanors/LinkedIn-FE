...
class AddComment extends React.Component {
  state = {
    addComment: {
      ...
      postId: this.props.id, //renamed elementId as postId
    },
    errMessage: "",
  }
    ...
    try {
      ...
      if (this.props.editedCm.comment._id) {
        response = await fetch(
          ...
          `${process.env.REACT_APP_BE_URL}/${this.state.postId}/comments/${this.props.editedCm.comment._id}`,
          {
            method: "PUT",
        ...
        response = await fetch(
          "https://striveschool-api.herokuapp.com/api/comments/",
          `${process.env.REACT_APP_BE_URL}/${this.state.postId}/comments`,
          {
            method: "POST",
            body: JSON.stringify(this.state.addComment),
            headers: new Headers({
